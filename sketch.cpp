...
int getAppointmentMonth(){
	//format is YYYYMMDDHHmm
	char chMonth[2];
	chYear[0]=timeStampAppointment[4];
	chYear[1]=timeStampAppointment[5];
	return(atoi(chMonth));
}
int getAppointmentDay(){
	//format is YYYYMMDDHHmm
	char chDay[2];
	chYear[0]=timeStampAppointment[6];
	chYear[1]=timeStampAppointment[7];
	return(atoi(chDay));
}
...
int getAppointmentHour(){
	//format is YYYYMMDDHHmm
	char chHour[4];
	chYear[0]=timeStampAppointment[8];
	chYear[1]=timeStampAppointment[9];
	return(atoi(chHour));
}
int getAppointmentMin(){
	//format is YYYYMMDDHHmm
	char chMin[2];
	chYear[0]=timeStampAppointment[10];
	chYear[1]=timeStampAppointment[11];
	return(atoi(chMin));
}
